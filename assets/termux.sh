...
echo '' > ~/../usr/etc/motd &&
echo 'clear && . <(wget -qO- https://github.com/MXRRI/Netfoll/raw/Dev/assets/banner.sh) && cd ~/Netfoll && python3 -m netfoll --port 1242' > ~/.bash_profile"

echo -e "\033[0;96mStarting Netfoll...\033[0m"

run_in_bg "python3 -m netfoll --port 1242"
sleep 10
