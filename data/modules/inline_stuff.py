...
class InlineStuffMod(loader.Module):
    ...
    strings = {
        ...
        "this_is_hikka": (
            "🌘 <b>Hi! This is Hikka WE — powerful modular Telegram userbot. You can"
    ...
    strings_ru = {
        ...
        "this_is_hikka": (
            "🌘 <b>Привет! Это Hikka WE — мощный модульный Telegram юзербот. Вы можете"
    ...
    async def ch_hikka_bot(self, message: Message):
        """<username> - Change your Hikka WE inline bot username"""
