...
class LoaderMod(loader.Module):
    ...
    strings = {
        ...
        "inline_init_failed": (
            ...
            " Hikka WE inline feature and initialization of InlineManager"
    ...
    strings_ru = {
        "we_compatible": "\n❤️ Совместимо с Windows Edition!",
    ...
    async def load_module(
        ...
        we = re.search(r"# ?scope: ?hikka_we", doc)
        we = True if we else False
        ...
        def loaded_msg(use_subscribe: bool = True):
            ...
            return self.strings("loaded").format(
                ...
                version,
                utils.ascii_face(),
                self.strings("we_compatible") if we else "",
                modhelp,
    ...
    async def _update_modules(self):
        ...
        with contextlib.suppress(AttributeError):
            await self.lookup("HikkaRestart").full_restart_complete(self._secure_boot)
