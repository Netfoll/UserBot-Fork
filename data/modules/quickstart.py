...
class QuickstartMod(loader.Module):
    ...
    strings = {
        "name": "Quickstart",
        "base": """🌘🇬🇧 <b>Hello.</b> You've just installed <b>Hikka WE</b> userbot.
...
💡 <b>Hikka WE supports modules from Friendly-Telegram and GeekTG, as well as its own ones.</b>""",
    ...
    strings_ru = {
        "base": """🌘🇷🇺 <b>Привет.</b> Твой юзербот <b>Hikka WE</b> установлен.
...
""",
    ...
    strings_de = {
        "base": """🌘🇩🇪 <b>Hallo.</b> Dein Userbot <b>Hikka WE</b> ist installiert.
...
""",
    ...
    strings_uz = {
        "base": """🌘🇺🇿 <b>Salom.</b> <b>Hikka WE</b> Sizning yuzer botingiz sozlandi.
...
""",
    ...
    strings_tr = {
        "base": """🌘🇹🇷 <b>Merhaba.</b> <b>Hikka WE</b> kullanıcı botunuz kuruldu.
...
""",
    ...
    strings_hi = {
        "base": """🌘🇮🇳 <b>नमस्ते.</b> आपका <b>Hikka WE</b> उपयोगकर्ता बॉट स्थापित किया गया है.
                ...
                [
                    {
                        ...
                        "url": "https://t.me/hikkawe_support",
                    }
                ],
            ]
            + [
