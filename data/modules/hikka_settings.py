...
class HikkaSettingsMod(loader.Module):
    ...
    strings = {
        ...
        "deauth_confirm": (
            "⚠️ <b>This action will fully remove Hikka WE from this account and can't be"
            " reverted!</b>\n\n<i>- Hikka chats will be removed\n- Session will be"
            " terminated and removed\n- Hikka inline bot will be removed</i>"
        ),
        "deauth_confirm_step2": (
            "⚠️ <b>Are you really sure you want to delete Hikka WE?</b>"
        ),
        "deauth_yes": "I'm sure",
        ...
        "uninstall": "😢 <b>Uninstalling Hikka WE...</b>",
        "uninstalled": (
            "😢 <b>Hikka WE uninstalled. Web interface is still active, you can add another"
            " account</b>"
        ),
    ...
    strings_ru = {
        ...
        "deauth_confirm": (
            "⚠️ <b>Это действие полностью удалит Hikka WE с этого аккаунта! Его нельзя"
            " отменить</b>\n\n<i>- Все чаты, связанные с Hikka будут удалены\n- Сессия"
            " Hikka будет сброшена\n- Инлайн бот Hikka будет удален</i>"
        ),
        "deauth_confirm_step2": "⚠️ <b>Ты точно уверен, что хочешь удалить Hikka WE?</b>",
        "deauth_yes": "Я уверен",
        ...
        "uninstall": "😢 <b>Удаляю Hikka WE...</b>",
        "uninstalled": (
            "😢 <b>Hikka WE удалена. Веб-интерфейс все еще активен, можно добавить другие"
            " аккаунты!</b>"
        ),
    ...
    @loader.owner
    @loader.command(
        ru_doc="Удалить Hikka WE",
        de_doc="Hikka WE deinstallieren",
        tr_doc="Hikka WE'yı kaldır",
        uz_doc="Hikka WE'ni o'chirish",
        hi_doc="हिक्का को अनइंस्टॉल करें",
        ja_doc="HikkaWEをアンインストールします",
        kr_doc="HikkaWE를 제거합니다",
        ar_doc="إلغاء تثبيت هيكا",
        es_doc="Desinstalar Hikka WE",
    )
