    ...
    async def _badge(self, client: CustomTelegramClient):
        ...
        try:
            logo1 = f"""
             ...
             ______  _______ _______ _______ _____  _       _       
            |  ___ \(_______|_______|_______) ___ \| |     | |      
            | |   | |_____   _       _____ | |   | | |     | |      
            | |   | |  ___) | |     |  ___)| |   | | |     | |      
            | |   | | |_____| |_____| |    | |___| | |_____| |_____ 
            |_|   |_|_______)\______)_|     \_____/|_______)_______)                            
            ...
            if not self.omit_log:
                print(logo1)
                logging.info(
                    "☺ Netfoll %s now started",
                    ".".join(list(map(str, list(__version__)))),
                )
                self.omit_log = True

            logging.info("- Started for UserID %s -", client._tg_id)
            logging.info("Check your UserBot in Telegram")
        except Exception:
