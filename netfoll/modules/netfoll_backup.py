...
class NetfollBackupMod(loader.Module):
    ...
    strings = {
        "name": "NetfollBackup",
        "period": (
            " ❗️<b>I advise you to enable the auto-backup function</b> <i>(Unit Alpha)</i>"
            " <b><i>From time to time, the Unit will create backups of your config to easily return all data in case of failure </i>\n"
            "In case of loss of the config, the developers will not return your data in any way\n\n"
            "</b> ‼️ <b> Don't share config files with anyone, even with Netfoll developers! They contain confidential data\n\n"
            "<i>To manually change the time of the autobackup, use </i></b><code>.autobackup\n\n"
            "</code>🔻 <b>Select the Auto-backup period</b>"
        ),
        "saved": (
    ...
    strings_uk = {
        "period": (
            ...
            "</b>‼️<b> Ні з ким не діліться файлами конфігура, навіть з розробниками Netfoll! Вони містять конфіденційні дані\n\n"
