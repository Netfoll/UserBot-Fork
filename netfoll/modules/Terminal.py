...
class TerminalMod(loader.Module):
    ...
    strings_ru = {"name": "Terminal",
               "flood_wait_protect_cfg_doc": "Сколько времени ждать в секундах между правками в командах",
               "what_to_kill": "<b>Ответьте на команду терминала, чтобы завершить его</b>",
               "kill_fail": "<b>Не удалось убить процесс</b>",
               "killed": "<b>Убит</b>",
               "no_cmd": "<b>В этом сообщении не выполняется ни одна команда</b>",
               "running": "<b>Выполняющаяся команда</b> <code>{}</code>",
               "finished": "\n<b>Команда завершена с кодом </b> <code>{}</code>",
               "stdout": "\n<b>Вывод:</b>\n<code>",
               "stderr": "</code>\n\n<b>Ошибка:</b>\n<code>",
               "end": "</code>",
               "auth_fail": "<b>Проверка подлинности не удалась, пожалуйста, попробуйте еще раз</b>",
               "auth_needed": "<a href=\"tg://user?id={}\">Требуется аутентификация</a>",
               "auth_msg": ("<b>Пожалуйста, измените это сообщение на пароль для</b> "
                            "<code>{}</code> <b>для запуска</b> <code>{}</code>"),
               "auth_locked": "<b>Проверка подлинности не удалась, пожалуйста, повторите попытку позже</b>",
